package model.maze.algo.generation;

import model.maze.model.Cell;
 ...
 * to the other in one way and the model.maze has no cycles.
 ...
 * It corresponds with the following model.maze where the entrance, the exit
 ...
 * model.maze. After the size is decreased grid turns into the following
 ...
 * |_|_|_| |
 * </pre>
 * And, after "deleting" some random edges, a model.maze becomes:
 * <pre>
 *    _____
 * | |___  |
 * | |  _  |
...
public class PassageTree {
    ...
    /**
     * The height of the model.maze in an imaginary edge form.
     */
    private int height;

    /**
     * The width of the model.maze in an imaginary edge form.
     */
    private int width;
     ...
     * an original form such that a model.maze is simply connected.
     *

package model.maze.algo.solving;
...
import static model.maze.model.Cell.Type.ESCAPE;

/**
 * This class is used for finding an escape path from the model.maze
 * entrance to the model.maze exit. It is the implementation of the
...
public class Fugitive {
    ...
    /**
     * The height of the model.maze in nodes.
     */
    private int height;

    /**
     * The width of the model.maze in node.
     */
    private int width;

    /**
     * Two-dimensional array of nodes representing model.maze.
     */
    private Node[][] grid;
     ...
     * based on that.
     *
     * @param grid  a grid of cells of a model.maze
